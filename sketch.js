...
function draw() {
  ...
  // function for crouching of player1
...
// computer movements & moblie movements
if(touches.length>0&&touches[0].x>125&&touches[0].x<175&&touches[0].y>windowHeight-175&&touches[0].y<windowHeight-125){
  Player1.x+=6;
  if(Player1.x<Player2.x){
    Player1.changeAnimation("right_LS_1",Player1_LS_anim_move_right);
...
if(touches.length>0&&touches[0].x>25&&touches[0].x<75&&touches[0].y>windowHeight-175&&touches[0].y<windowHeight-125){
  Player1.x-=6;
  if(Player1.x<Player2.x){
    Player1.changeAnimation("left_LS_1",Player1_LS_anim_move_left);
...
// function for jumping player1
if(touches.length>0&&touches[0].x>75&&touches[0].x<125&&touches[0].y>windowHeight-225&&touches[0].y<windowHeight-150){
  Player1.velocityY=-15;
  if(Player1.x<Player2.x){
    Player1.changeAnimation("jump_LS_1",Player1_LS_anim_jump);
...
if(touches.length>0&&touches[0].x>75&&touches[0].x<125&&touches[0].y>windowHeight-125&&touches[0].y<windowHeight-140){
  Player1.x+=6;
  if(Player1.x<Player2.x){
    Player1.changeAnimation("right_LS_1",Player1_LS_anim_move_right);
